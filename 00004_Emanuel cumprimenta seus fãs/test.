describe("Exercício 4", function() {
  ...
  it("Cumprimentar", function() {
    ...
    var cumprimento = ginobili.cumprimentar("Martin");
    ...
    assert(
      cumprimento === "Olá Martin eu sou o Emanuel",
      `O método cumprimentar está retornando o texto '${cumprimento}' em vez de  'Olá Martin eu sou o Emanuel'`
    );
  });
});
